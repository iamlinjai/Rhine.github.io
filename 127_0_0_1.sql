...
INSERT INTO `item` (`item_title`, `item_desc`, `price`, `item_img`, `itemid`, `end_date`, `buyer_id`, `userid`, `item_status`) VALUES
('demo 1', 'good', 110, 0x6970686f6e652e6a7067, 48, '2023-01-03', 222, 111, 'Completed');
...
INSERT INTO `user` (`username`, `email`, `profile_image`, `pw`, `userid`) VALUES
('jacky', '111', 0x313634363534383939385f73656c6669652e6a7067, '111', 111),
('dicky', '222', NULL, '222', 222);
...
ALTER TABLE `user`
  ...
  ADD KEY `user_nickname` (`username`),
...
('root', '[{\"db\":\"bidding_system\",\"table\":\"item\"},{\"db\":\"bidding_system\",\"table\":\"user\"},{\"db\":\"bidding_system\",\"table\":\"mybids\"}]');
...
('root', '2022-03-28 16:28:56', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_TW\"}');
